...
function _encodeHelloRequest(message, bb) {
  ...
  // optional string longMessage = 2;
  let $longMessage = message.longMessage;
  if ($longMessage !== undefined) {
    writeVarint32(bb, 18);
    writeString(bb, $longMessage);
  }
...
export function decodeHelloRequest(binary) {
  return _decodeHelloRequest(wrapByteBuffer(binary));
}

function _decodeHelloRequest(bb) {
  let message = {};
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // optional string longMessage = 2;
      case 2: {
        message.longMessage = readString(bb, readVarint32(bb));
        break;
      }
...
function _encodeHelloData(message, bb) {
  ...
  if ($greeting !== undefined) {
    writeVarint32(bb, 10);
    writeString(bb, $greeting);
  }

  // optional string echoedMessage = 2;
  let $echoedMessage = message.echoedMessage;
  if ($echoedMessage !== undefined) {
    writeVarint32(bb, 18);
    writeString(bb, $echoedMessage);
  }
  ...
  if ($processedAt !== undefined) {
    writeVarint32(bb, 26);
    writeString(bb, $processedAt);
  }

  // optional int32 originalMessageSize = 4;
  let $originalMessageSize = message.originalMessageSize;
  if ($originalMessageSize !== undefined) {
    writeVarint32(bb, 32);
    writeVarint64(bb, intToLong($originalMessageSize));
  }
}
...
function _decodeHelloData(bb) {
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // optional string greeting = 1;
      case 1: {
        message.greeting = readString(bb, readVarint32(bb));
        break;
      }

      // optional string echoedMessage = 2;
      case 2: {
        message.echoedMessage = readString(bb, readVarint32(bb));
        break;
      }

      // optional string processedAt = 3;
      case 3: {
        message.processedAt = readString(bb, readVarint32(bb));
        break;
      }
